...
class TestTemplateVersionSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TemplateVersionSpec:
        """Test TemplateVersionSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateVersionSpec`
        """
        model = TemplateVersionSpec()
        if include_optional:
    ...
    def testTemplateVersionSpec(self):
        """Test TemplateVersionSpec"""
